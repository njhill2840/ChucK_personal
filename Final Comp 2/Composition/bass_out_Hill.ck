...
//same as original bassline, just less time playing--easier to make new file when I wasn't sure how i was ending it
...
while (bassline<3) //while loop that incorporates whole bassline--only difference, now set to 3
{  
